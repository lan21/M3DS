...
INCLUDEPATH += src/application/ src/p3d/algebra/ src/p3d/gui/ src/p3d/scene/ src/p3d/render/ 
DEPENDPATH += src/application/ src/p3d/algebra/ src/p3d/gui/ src/p3d/scene/ src/p3d/render/ 

SOURCES += \
	src/application/GLApplication.cpp \
	src/application/CatmullRomCurve.cpp \
...
HEADERS += \
	...
	src/application/CatmullRomCurve.h \
	src/application/Curve.h \
	src/p3d/scene/InteractPosition.h \
	src/p3d/scene/Camera.h \
	src/p3d/scene/Object3D.h \
	src/p3d/algebra/Plane.h \
	src/p3d/algebra/Line.h \
	src/application/Hermite.h \
